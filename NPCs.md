...
So as near as I can test empirically testing pre Starfield 1.10.31.0 the default template actor was a suggestion as far as being overridden goes and only the specific template actors would force override fields. After Starfield 1.10.31.0 the default template actor's filed now force override too. Do you should use one or the other default or specific not both.
